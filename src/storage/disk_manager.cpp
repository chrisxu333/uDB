...
namespace udb
{
    ...
    void DiskManager::shutDown(){
        if(db_file_io_.is_open()) db_file_io_.close();
    }

    void DiskManager::storePage(page_id_t page_id, char* page_data){
    ...
    void DiskManager::loadPage(page_id_t page_id, char* page_data){
